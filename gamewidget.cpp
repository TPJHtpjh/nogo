    ...
    ui(new Ui::GameWidget)
{
    ...
    ui->chatInput->setStyleSheet("color: rgb(255, 0, 0); background-color: #01e6ff;"
                                 "border-width: 1px; border-style: solid;"
                                 "border-color: #01e6ff #01e6ff rgb(255, 0, 0) #01e6ff;");
    ui->chatHistory->setStyleSheet("color: rgb(255, 0, 0); background-color: #01e6ff;"
                                   "border-style: none;");
...
void GameWidget::setColorForBar()
{
    ...
    if(judge->CurColor() == -1) // White
    {
        ui->TimeBar->setStyleSheet("QProgressBar{"
                                   "background:rgba(180, 20, 255, 0.8);"
                                   "color:white;"
                                   "border-radius:5px;}"
                                   "QProgressBar::chunk{"
                                   "border-radius:5px;"
    ...
    {
        ui->TimeBar->setStyleSheet("QProgressBar{"
                                   "background:rgba(20, 55, 180, 0.666);"
                                   "color:white;"
                                   "border-radius:5px;}"
                                   "QProgressBar::chunk{"
                                   "border-radius:5px;"
...
void GameWidget::paintEvent(QPaintEvent *event)
{
    ...
    if(autoControl->isToggled()){
        if(judge->playerRole == 1){ // black
            ui->autoLabel->setStyleSheet("color: rgb(20, 55, 180)"); // CUS_BLACK_PRIMARY
            autoControl->setCheckedColor(QColor(24, 192, 250));
            autoControl->setBackgroundColor(QColor(240, 23, 19));
        }
        else{ // white
            ui->autoLabel->setStyleSheet("color: rgb(180, 20, 55)");
