...
#define ACCENT_COLOR "color: rgb(180, 235, 37)"

#define CUS_BLACK 0xEAACB8 // RED -> BLACK
#define CUS_WHITE 0x7ACBF5 // BLUE -> WHITE
#define CUS_BLACK_PRIMARY "color: rgb(78, 29, 184)"
//#define CUS_BLACK_LIGHTEN "color: rgb(240, 23, 189)"
#define CUS_WHITE_PRIMARY "color: rgb(162, 23, 245)"
//#define CUS_WHITE_LIGHTEN "color: rgb(196, 205, 233)"
